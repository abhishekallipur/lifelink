...
1. **Download & Install** LifeLink on Android.  
2. **Register/Login** with your basic details.  
3. **Select Emergency Type** (e.g., Heart Attack, Accident, Injury).  
4. **Send SOS** – Your alert will hop across nearby devices via Bluetooth.  
5. If any phone has **Internet**, your SOS will also reach emergency responders or hospitals.  
...
### 🔹 LifeLink Mobile App  
<img src="screenshot1.jpg" alt="LifeLink App Screenshot" width="300"/>  

### 🔹 SOS Receiving Website  
<img src="website.jpg" alt="LifeLink Website SOS Message" width="600"/>  
<img src="website1.jpg" alt="LifeLink Website Dashboard" width="600"/>  
...
🔥 With **LifeLink**, your cry for help doesn’t depend on network towers — it depends on the **people around you**.  
