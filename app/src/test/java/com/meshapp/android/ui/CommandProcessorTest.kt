package com.meshapp.android.ui

import android.content.Context
import androidx.test.core.app.ApplicationProvider
import com.meshapp.android.mesh.BluetoothMeshService
import com.meshapp.android.model.MeshMessage
...
class CommandProcessorTest() {
  ...
  fun `when using lower case join command, user is correctly added to channel`() {
    ...
    val expectedMessage = MeshMessage(
      sender = "system",
